                    ...
                    <div className={`${cls.cross} cross`} onClick={() => disableHandler()}>
                        <svg width="15" height="15" viewBox="0 0 37 38" xmlns="http://www.w3.org/2000/svg">
                            <rect
                                ...
                                fill="#5f6367"
                            />
                            <rect x="32.6185" width="5" height="47" rx="1" transform="rotate(43.9485 32.6185 0)"
                                  fill="#5f6367"/>
                        </svg>
                    </div>
                </div>
                <div className={cls.boardFormContainer}>
                    <form
                        ...
                        onSubmit={handleSubmit((data, event) => {
                            onSubmitTask(event as FormEvent<HTMLFormElement>)
                            disableHandler()
                        })}
                    >
                        <div className={`${cls.formElement} ${errors.name ? cls.errorFormElement : ''}`}>
                            <div className={cls.formElementIcon}></div>

                            <input{...register("name", {
                                required: 'Not valid', pattern: {
                                    value: /^[^\s].*/,
                                    message: 'First character could not be space'
                                }
                            })} type="text"
                        ...
                        <div className={cls.formElement}>
                            <div className={cls.formElementIcon}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#606468" viewBox="0 0 32 32" width="25"
                                     height="25">
                                    <path
